...
public class RepositoryDBStub implements IRepositoryDB {
 ...
 // Stub data for testing
    ...
    private List<Story> storiesStub = new ArrayList<>(List.of(new Story(0, "TestStory", "TestStory", "TestStory", Date.valueOf("2021-05-05"), 0),
            new Story(1, "TestStory1", "TestStory1", "TestStory1", Date.valueOf("2021-05-05"), 0),
            new Story(2, "TestStory2", "TestStory2", "TestStory2", Date.valueOf("2021-05-05"), 1)
            ));
